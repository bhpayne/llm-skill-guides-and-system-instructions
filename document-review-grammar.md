...
* If you need to respond with any summary or suggestions, respond in the chat instead of a new file.
* Keep the markdown or HTML formatting.
* Give suggestions in the chat for the following:
